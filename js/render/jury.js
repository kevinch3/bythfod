...
export class JuryRend {
  constructor(rootEl) {
    ...
    this.$caption = this.root.querySelector('.j-caption');
    this._mode = null;
    this._shown = '';
    this._judge = null;
